        ...
        <form action="guardarActualizar" class="needs-validation" method="post" novalidate>
            <div class="diccionarioFormulario" idDiccionario="20">
                ...
                <div class="titulares" id="titulares">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="primaryCpeCliente_si_1" class="cpeCliente" name="cpeCliente_1" value="S" required />
                                            <label for="primaryCpeCliente_si_1">Sí</label>
                                        </div>
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="primaryCpeCliente_no_2" class="cpeCliente" name="cpeCliente_1" value="N" required />
                                            <label for="primaryCpeCliente_no_2">No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card card-primary" id="2">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-check">
                                        ...
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="siActuaCliente_2" class="actuaNombrePropio" name="tipoActuacionCliente_2" value="C" required/>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label for ="calidadActuaCliente_2">Calidad con que actúa</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>País</label>
                                        <select name="paisCaMiCliente_2" id="paisCaMiCliente_2" class="form-control custom-select paisCaMiCliente deshabilitaDepartamentoMunicipio setPais" style="width: 100%" required>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($paises as $pais)
                                            <option value="{{$pais->idPais}}">{{$pais->nombrePais}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Departamento</label>
                                        <select name="deptoCaMiCliente_2" id="deptoCaMiCliente_2" class="form-control custom-select deptoCaMiCliente getMunicipio" style="width: 100%" required disabled>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($departamentos as $departamento)
                                            <option value="{{$departamento->idDepartamento}}">{{$departamento->nombreDepartamento}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Municipio</label>
                                        <select name="muniCaMiCliente_2" id="muniCaMiCliente_2" class="form-control custom-select muniCaMiCliente setMunicipio" style="width: 100%" required disabled>
                                            <option value="" disabled selected>Selecciona</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label for="apellidoCasadaCliente_2">Apellido casada</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>País nacimiento</label>
                                        <select name="paisNacimientoCliente_2" id="paisNacimientoCliente_2" class="form-control custom-select paisNacimientoCliente deshabilitaDepartamentoMunicipio setPais" style="width: 100%" required>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($paises as $pais)
                                            <option value="{{$pais->idPais}}">
                                                {{$pais->nombrePais}}
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Departamento nacimiento</label>
                                        <select name="deptoNacimientoCliente_2" id="deptoNacimientoCliente_2" class="form-control custom-select deptoNacimientoCliente getMunicipio" style="width: 100%" required disabled>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($departamentos as $departamento)
                                            <option value="{{$departamento->idDepartamento}}">{{$departamento->nombreDepartamento}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Municipio nacimiento</label>
                                        <select name="muniNaciminentoCliente_2" id="muniNaciminentoCliente_2" class="form-control custom-select muniNaciminentoCliente setMunicipio" style="width: 100%" required disabled>
                                            <option value="" disabled selected>Selecciona</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Condición migratoria</label>
                                        <select name="condicionMigratoriaCliente_2" id="condicionMigratoriaCliente_2" class="form-control custom-select condicionMigratoriaCliente" style="width: 100%" disabled required>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($listaCondicionMigratoria as $condicionMigratoria)
                                            <option value="{{$condicionMigratoria->idListaCondicionMigratoria}}">{{$condicionMigratoria->descripcion}}</option>
                                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label>Sexo</label>
                                        <select name="sexoCliente_2" id="sexoCliente_2" class="form-control custom-select sexoCliente" style="width: 100%" required>
                                            <option value="" disabled selected>Selecciona</option>
                                            <option value="M">Masculino</option>
                                            <option value="F">Femenino</option>
                                        </select>
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Estado civil</label>
                                        <select name="estadoCivilCliente_2" id="estadoCivilCliente_2" class="form-control custom-select estadoCivilCliente" style="width: 100%" required>
                                            <option value="" disabled selected>Selecciona</option>
                                            <option value="S">Soltero</option>
                                            <option value="C">Casado</option>
                                        </select>
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Docto. identificación</label>
                                        <select name="tipoDoctoIdentificacionCliente_2" id="tipoDoctoIdentificacionCliente_2" class="form-control custom-select tipoDoctoIdentificacionCliente validaPaisPasaporte" style="width: 100%" required>
                                            <option value="" disabled selected>Selecciona</option>
                                            <option value="D">DPI</option>
                                            <option value="P">Pasaporte</option>
                                        </select>
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Número identificación</label>
                                        <input name="noDocIdentificacionCliente_2" id="noDocIdentificacionCliente_2" type="text" class="form-control noDocIdentificacionCliente" placeholder="Número identificación..." maxlength="20" required disabled/>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>País (Pasaporte)</label>
                                        <select name="emicionPasaporteCliente_2" id="emicionPasaporteCliente_2" class="form-control custom-select emicionPasaporteCliente" style="width: 100%" disabled required>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($paises as $pais)
                                            <option value="{{$pais->idPais}}">{{$pais->nombrePais}}</option>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Profesión u oficio</label>
                                        <input name="profecionOficioCliente_2" id="profecionOficioCliente_2" type="text" class="form-control profecionOficioCliente" placeholder="Profesión u oficio ..." maxlength="100" required />
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Correo electrónico</label>
                                        <input name="emailCliente_2" id="emailCliente_2" type="email" class="form-control emailCliente" placeholder="Correo electrónico ..." maxlength="100" />
                                    </div>
                                </div>
                            </div>
                            <!-- .row -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <label>Dirección de residencia completa (calle o avenida, número de casa, colonia, sector, lote, manzana, otros)</label>
                                    <input name="direccionRecidenciaCliente_2" id="direccionRecidenciaCliente_2" type="text" class="form-control direccionRecidenciaCliente" placeholder="Dirección de residencia completa ..." maxlength="400" required />
                                </div>
                            </div>
                            <!-- .row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>País residencia</label>
                                        <select name="paisRecidenciaCliente_2" id="paisRecidenciaCliente_2" class="form-control custom-select paisRecidenciaCliente deshabilitaDepartamentoMunicipio setPais" style="width: 100%" required>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($paises as $pais)
                                            <option value="{{$pais->idPais}}">{{$pais->nombrePais}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Departamento residencia</label>
                                        <select name="deptoRecidenciaCliente_2" id="deptoRecidenciaCliente_2" class="form-control custom-select deptoRecidenciaCliente getMunicipio" style="width: 100%" required disabled>
                                            <option value="" disabled selected>Selecciona</option>
                                            @foreach($departamentos as $departamento)
                                            <option value="{{$departamento->idDepartamento}}">{{$departamento->nombreDepartamento}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label>Municipio residencia</label>
                                        <select name="muniRecidenciaCliente_2" id="muniRecidenciaCliente_2" class="form-control custom-select muniRecidenciaCliente setMunicipio" style="width: 100%" required disabled>
                                            <option value="" disabled selected>Selecciona</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm" id="nacionalidadCliente_2">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm">
                                                <label>Nacionalidad</label>
                                                <select name="nacionalidadCliente_2" id="nacionalidadCliente_1_2" class="form-control custom-select nacionalidadCliente" style="width: 100%" required>
                                                    <option value="" disabled selected>Selecciona</option>
                                                    @foreach($paises as $pais)
                                                    <option value="{{$pais->idPais}}">{{$pais->nombrePais}}</option>
                                                    @endforeach
                                ...
                                <!-- .nacionalidad -->
                                <div class="col-sm" id="telefonosCliente_2">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm">
                                                <label>Telefonos:</label>
                                                <input name="telefonoCliente_2" id="telefonoCliente_1_2" type="text" class="form-control telefonoCliente" placeholder="telefono ..." maxlength="30" required />
                                            </div>
                                            <div class="col-sm"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <button type="button" id="agregarTelefonoCliente_2" class="btn btn-primary agregarTelefonoCliente">
                                            Agregar teléfono
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="primaryCpeCliente_si_2" class="cpeCliente" name="cpeCliente_2" value="S" required />
                                            <label for="primaryCpeCliente_si_2">Sí</label>
                                        </div>
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="primaryCpeCliente_no_2" class="cpeCliente" name="cpeCliente_2" value="N" required />
                                            <label for="primaryCpeCliente_no_2">No</label>
                                        </div>
                                    </div>
                                </div>
