                            ...
                            <div class="row">
                                    ...
                                    <div class="form-check">
                                       <div>
                                        ...
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="siActuaCliente_1" class="actuaNombrePropio form-check-input" name="tipoActuacionCliente_1" value="C" required {{ $titular->tipoActuacion == 'C' ? 'checked' : ''}}/>
                                            <label for="siActuaCliente_1">Sí</label>
                                        </div>
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="noActuaCliente_1" class="actuaNombrePropio form-check-input" name="tipoActuacionCliente_1" value="R" required {{ $titular->tipoActuacion == 'R' ? 'checked' : ''}}/>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <input name="calidadActuaCliente_1" id="calidadActuaCliente_1" type="text" class="form-control calidadActua" placeholder="Calidad con que actúa ..." maxlength="100" {{ $titular->tipoActuacion == 'R' ? '' : 'disabled'}} value="{{$titular->calidadActua}}"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <select name="deptoCaMiCliente_1" id="deptoCaMiCliente_1" class="form-control custom-select deptoCaMiCliente getMunicipio select2" style="width: 100%" required {{$titular["lugar"]["pais"] == 'GT' ? '' : 'disabled'}}>
                                            <option value="" disabled selected>Selecciona</option>
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <select name="muniCaMiCliente_1" id="muniCaMiCliente_1" class="form-control custom-select muniCaMiCliente setMunicipio select2" style="width: 100%" required {{$titular["lugar"]["pais"] == 'GT' ? '' : 'disabled'}}>
                                            <option value="" disabled selected>Selecciona</option>
                                        </select>
                                    </div>
                                </div>
