...
<html>
    <head lang="es">
        ...
        <title>Oficio IVE Núm 712-2020</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <div class="content-wrapper">@yield('contenido')</div>
            <!-- /.content-wrapper -->
            <footer class="main-footer">
                <strong
                    >Copyright &copy; 2020
                    <a href="http://marvinesteban.com">MARVINESTEBAN.COM</a
                    >.</strong
                >
