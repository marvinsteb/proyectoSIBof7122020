...
function habilitaDepartamentoMunicipio(selectPais) {
    for (let i = 0; i < selectPais.length; i++) {
        $(selectPais[i]).change(function () {
            let departamento = $(this)
                .parent()
                .parent()
                .parent()
                .find("select.getMunicipio");
            let municipio = $(this)
                .parent()
                .parent()
                .parent()
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <select name="deptoNacimientoCliente_${id}" id="deptoNacimientoCliente_${id}" class="form-control deptoNacimientoCliente setDepartamento" style="width: 100%" required>
                                    <option value="" disabled selected>Selecciona</option>
                                </select>
                            </div>
                        </div>
